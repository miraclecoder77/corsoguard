...
export default function ChecklistClient() {
    ...
    if (!isLoaded) return <div className="min-h-screen pt-24 pl-8 text-neutral-500">Loading Tactical Protocol...</div>;

    return (
        <div className="space-y-12">
            <div className="bg-black/50 border border-white/10 p-6 rounded-2xl flex flex-col items-center justify-center min-w-[200px] md:absolute md:top-24 md:right-8 lg:right-16 md:mt-12">
                <div className="text-5xl font-black text-white">{score}<span className="text-2xl text-primary">%</span></div>
                <div className="text-neutral-400 text-sm font-bold uppercase tracking-wider mt-1">Ready for Field Duty</div>
            </div>
